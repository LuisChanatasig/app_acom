...
class _SplashScreenState extends State<SplashScreen>
  ...
  // — Partículas / íconos flotantes
  late AnimationController _particleController;
  late Animation<double> _particleOpacity;

  // — Pulsación del fondo (halo)
            ...
            child: Column(
              ...
              children: [
                          ...
                          return Opacity(
                            ...
                            child: Stack(
                              ...
                              children: _icons.map((fi) {
                                final delayedOpacity = (_particleOpacity.value - fi.delay).clamp(0.0, 1.0) / (1.0 - fi.delay).clamp(0.01, 1.0);
                ...
                AnimatedBuilder(
                  ...
                  builder: (_, _) {
                    return _LoadingDots(progress: _dotsController.value);
                  },
                ),
              ],
            ),
