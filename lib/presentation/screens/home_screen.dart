...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  final List<_Conversation> _conversations = const [
    _Conversation(
      title: 'Sobre mi día',
      preview: 'Hoy me fue bien en el trabajo aunque estaba nervioso...',
      time: 'Hace 2h',
      emoji: '☀️',
    ),
    _Conversation(
      title: 'Mis miedos',
      preview: 'Me cuesta hablar de esto pero creo que necesito...',
      time: 'Ayer',
      emoji: '🌙',
    ),
    _Conversation(
      title: 'Logros de la semana',
      preview: 'Terminé el proyecto y me sentí muy orgulloso de...',
      time: 'Lun',
      emoji: '🏆',
    ),
  ];
  ...
  void initState() {
    ...
    _headerSlide = Tween(begin: const Offset(0, -0.15), end: Offset.zero).animate(
      CurvedAnimation(parent: _entryController,
          curve: const Interval(0.0, 0.6, curve: Curves.easeOutCubic)),
    );
    _cardsFade = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: _entryController,
          curve: const Interval(0.3, 1.0, curve: Curves.easeOut)),
    );
    _cardsSlide = Tween(begin: const Offset(0, 0.08), end: Offset.zero).animate(
      CurvedAnimation(parent: _entryController,
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: selected ? m.color : const Color(0xFF90A4AE),
                          ),
                        ),
                      ],
                    ),
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        ...
                        _moods[_selectedMood!].color.withOpacity(0.7),
                      ],
                    ),
